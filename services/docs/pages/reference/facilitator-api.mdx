...
<Callout type="info">
The [Sandbox](https://sandbox.t402.io) supports 7 testnets with [magic test addresses](https://sandbox.t402.io/test-addresses) for deterministic testing. Try the [playground](https://sandbox.t402.io/playground) to explore the API interactively.
</Callout>

## Authentication

The production facilitator requires an API key for `/verify` and `/settle` endpoints. Get a free key at [facilitator.t402.io/register](https://facilitator.t402.io/register).
