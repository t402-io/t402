...
|--------|-------------|----------|
| [`exact`](/schemes/exact) | Fixed amount payments | One-time purchases, subscriptions |
...
[Learn more about the upto scheme →](/schemes/upto)
...
| Network | `exact` | `upto` |
|---------|---------|--------|
| EVM (Base, Ethereum, Arbitrum) | ✅ EIP-3009 | ✅ EIP-2612 |
| Solana | ✅ SPL Transfer | 🚧 Planned |
| TON | ✅ Jetton Transfer | 🚧 Planned |
| TRON | ✅ TRC-20 Transfer | 🚧 Planned |
