...
│   ├── demo/                # demo.t402.io interactive demo
...
| Container Registry | https://github.com/t402-io/facilitator/pkgs/container/facilitator |
| Facilitator Repo | https://github.com/t402-io/facilitator |
...
| Python | 1.10.1 | PyPI | `python/v*` |
| Go | 1.9.0 | Go Modules | `go/v*` |
| Java | 1.10.0 | Maven Central | `java/v*` |
...
# Python
git tag python/v1.10.1 && git push origin python/v1.10.1

# Go
git tag go/v1.9.0 && git push origin go/v1.9.0

# Java
git tag java/v1.10.0 && git push origin java/v1.10.0
```
...
> **Note**: Facilitator source code has been moved to [t402-io/facilitator](https://github.com/t402-io/facilitator) (private repo).
...
**Facilitator not deploying (see [t402-io/facilitator](https://github.com/t402-io/facilitator)):**
...
| Deploy facilitator | Push to [t402-io/facilitator](https://github.com/t402-io/facilitator) main |
...
| [t402-io/facilitator](https://github.com/t402-io/facilitator) | Facilitator implementation (private repo) |
| `.github/workflows/` | CI/CD pipelines |
| `ROADMAP.md` | High-level project roadmap |
| `DEVELOPMENT_PLAN_2026.md` | Detailed 2026 development plan |
| `archive/plans/USDT_FULL_COVERAGE_PLAN.md` | Network coverage strategy |
