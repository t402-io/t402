...
|---------|------|-----------|---------|
| `@t402/express` | Server | Express 4–5 | 2.7.0 |
| `@t402/hono` | Server | Hono 4+ | 2.7.0 |
| `@t402/fastify` | Server | Fastify 4–5 | 2.7.0 |
| `@t402/next` | Server | Next.js 14–16 | 2.7.0 |
| `@t402/fetch` | Client | Fetch API | 2.7.0 |
| `@t402/axios` | Client | Axios 1.7+ | 2.7.0 |
