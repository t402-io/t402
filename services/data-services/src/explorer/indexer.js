...
const TOKEN_ADDRESS_MAP = {
  ...
  "0x588ce4f028d8e7b53b687865d6a67b3a54c75518": "USDT0",
...
export function startSync(facilitatorUrl, facilitatorApiKey, intervalMs = 60000, explorerDb) {
  ...
  async function doSync() {
    try {
      ...
      if (totalSynced > 0) {
        explorerDb.setLastSync(new Date().toISOString());
