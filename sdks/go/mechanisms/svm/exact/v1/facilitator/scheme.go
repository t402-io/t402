...
import (
	...
	svm "github.com/t402-io/t402/sdks/go/mechanisms/svm"
...
func (f *ExactSvmSchemeV1) GetExtra(network t402.Network) map[string]interface{} {
...
func (f *ExactSvmSchemeV1) GetSigners(network t402.Network) []string {
	addresses := f.signer.GetAddresses(context.Background(), string(network))
...
func (f *ExactSvmSchemeV1) Verify(
	...
	if requirements.Extra != nil {
		if err := json.Unmarshal(*requirements.Extra, &reqExtraMap); err != nil {
			return nil, t402.NewVerifyError("invalid_extra_field", "", network, err)
		}
	}
...
func (f *ExactSvmSchemeV1) Settle(
	...
	if requirements.Extra != nil {
		if err := json.Unmarshal(*requirements.Extra, &reqExtraMap); err != nil {
			return nil, t402.NewSettleError("invalid_extra_field", verifyResp.Payer, network, "", err)
		}
	}
