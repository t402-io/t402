...
export const alt = "Choosing the Right T402 SDK: TypeScript, Python, Go, or Java";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const title = "Choosing the Right T402 SDK: TypeScript, Python, Go, or Java";
const category = "Guide";
const color = "#10B981";
const slug = "sdk-comparison";
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: "8px", flexDirection: "row" }}>
              {["TypeScript", "Python", "Go", "Java"].map((lang) => (
                <div
                  key={lang}
                  style={{
                    display: "flex",
                ...
                >
                  <span style={{ fontSize: "12px", color: "#A1A1AA", fontWeight: 500 }}>{lang}</span>
                </div>
              ))}
            </div>
          </div>
