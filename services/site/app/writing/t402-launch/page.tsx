          ...
          <section className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 space-y-8">
            ...
            <div className="rounded-xl border border-border bg-background-secondary p-6">
              <p className="text-base leading-relaxed text-foreground-secondary">
                <strong className="text-foreground">TL;DR</strong>: T402 is an open-source payment protocol that embeds USDT payments directly into HTTP. It supports 28 blockchains across 10 families, offers zero transaction fees, instant settlement, and is designed for both human users and AI agents. Start accepting payments in minutes with our production-ready SDKs.
              </p>
            </div>
            ...
            <section className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="flex items-start gap-3 rounded-lg border border-border bg-background-secondary p-4">
                  <CheckIcon className="mt-0.5 text-brand flex-shrink-0" />
                  <div>
                    <p className="font-medium text-foreground">28 Blockchains</p>
