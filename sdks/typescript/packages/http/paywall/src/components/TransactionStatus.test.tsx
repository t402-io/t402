...
describe("TransactionStatus", () => {
  ...
  describe("getExplorerUrl", () => {
    it("returns Ethereum mainnet explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="0xabc123" network="eip155:1" />,
      );
    ...
    it("returns Base explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="0xdef456" network="eip155:8453" />,
      );
    ...
    it("returns Arbitrum explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="0x789ghi" network="eip155:42161" />,
      );
    ...
    it("returns TON mainnet explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="tonhash123" network="ton:mainnet" />,
      );
    ...
    it("returns TRON mainnet explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="tronhash" network="tron:mainnet" />,
      );
    ...
    it("returns Stacks mainnet explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="stxhash" network="stacks:1" />,
      );
    ...
    it("returns Cosmos noble-1 explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="cosmoshash" network="cosmos:noble-1" />,
      );
    ...
    it("returns NEAR mainnet explorer URL", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="nearhash" network="near:mainnet" />,
      );
    ...
    it("does not render explorer link for unknown network", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="hash123" network="unknown:network" />,
      );
  ...
  describe("truncateHash", () => {
    it("shows full hash when hash is short (<=16 chars)", () => {
      const html = renderToHtml(
        <TransactionStatus txHash="0x1234567890" network="eip155:1" />,
      );
    ...
    it("truncates long hashes to first 8 + ... + last 6", () => {
      ...
      const html = renderToHtml(
        <TransactionStatus txHash={longHash} network="eip155:1" />,
      );
  ...
  describe("accessibility", () => {
    it('has role="status" and aria-live="polite" on container', () => {
      const html = renderToHtml(
        <TransactionStatus txHash="0xabc" network="eip155:1" />,
      );
