...
export const sdks: SDK[] = [
  {
    ...
    description:
      "Full-featured SDK for Node.js and browser environments. Includes server middleware, client utilities, and framework integrations for 10 blockchain families.",
    icon: "typescript",
...
app = middleware(app)`,
  ...
  },
  {
    ...
    language: "Go 1.24+",
    description:
      "High-performance Go SDK for building payment-enabled APIs and services. Supports 10 blockchain families with the facilitator service built on it.",
    icon: "go",
...
http.Handle("/", middleware(handler))`,
  ...
  },
  {
    ...
    icon: "java",
    installCommand: "io.t402:t402:1.11.1",
