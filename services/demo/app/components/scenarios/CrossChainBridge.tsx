...
// Only chains with USDT0 OFT contracts (from docs.usdt0.to/api/deployments)
...
const BRIDGE_CHAIN_IDS: Record<string, number> = {
  ...
  polygon: 137, ink: 57073, berachain: 80094, unichain: 130, mantle: 5000,
  sei: 1329, monad: 143, conflux: 1030, flare: 14, rootstock: 30,
  xlayer: 196, stable: 988, corn: 21000000, plasma: 9745,
  megaeth: 4326, hyperevm: 999, morph: 2818, hedera: 295, tempo: 4217,
};

const BRIDGE_CHAINS: BridgeChain[] = [
  // Major (4 chains with highest volume)
