...
export const packages: EcosystemPackage[] = [
  ...
  {
    id: "wdk-facilitator",
    name: "@t402/wdk-facilitator",
    category: "wallet",
    description: "Adapter to use WDK wallets as self-custodial t402 facilitator signers.",
    language: "typescript",
    npmPackage: "@t402/wdk-facilitator",
    features: ["Self-custodial", "WDK wallet", "Facilitator signer", "Any EVM chain"],
    badge: "new",
  },
  {
    id: "wdk-swap-jupiter",
    name: "@t402/wdk-swap-jupiter",
    category: "wallet",
    description: "Jupiter DEX aggregator swap module for Solana wallets.",
    language: "typescript",
    npmPackage: "@t402/wdk-swap-jupiter",
    features: ["Jupiter V6", "ExactIn/ExactOut", "Slippage control", "Solana"],
    badge: "new",
  },
  {
    id: "wdk-lending",
    name: "@t402/wdk-lending",
    category: "wallet",
    description: "DeFi lending protocol abstractions — supply, withdraw, borrow, repay.",
    language: "typescript",
    npmPackage: "@t402/wdk-lending",
    features: ["Aave V3", "Supply/Borrow", "Health factor", "Protocol-agnostic"],
    badge: "new",
  },
  {
    id: "wdk-fiat",
    name: "@t402/wdk-fiat",
    category: "wallet",
    description: "Fiat on/off-ramp abstractions — buy and sell crypto with fiat.",
    language: "typescript",
    npmPackage: "@t402/wdk-fiat",
    features: ["MoonPay", "Buy/Sell", "Multi-currency", "KYC-aware"],
    badge: "new",
  },
  {
    id: "erc8004",
