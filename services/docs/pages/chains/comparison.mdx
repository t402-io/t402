...
The client signs an off-chain authorization. The facilitator executes the transfer on-chain. Supported on EVM (via EIP-3009), Solana, TON, and TRON.
...
|-----|---------|----------|
| TypeScript | 2.6.0 | [npm](https://www.npmjs.com/org/t402) |
| Go | 1.11.0 | [pkg.go.dev](https://pkg.go.dev/github.com/t402-io/t402/sdks/go) |
| Python | 1.11.0 | [PyPI](https://pypi.org/project/t402) |
| Java | 1.11.0 | [Maven Central](https://central.sonatype.com/artifact/io.t402/t402) |
