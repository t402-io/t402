...
<div className="chain-tags">
  <a href="/chains/evm" className="chain-tag">🔷 EVM Chains</a>
  ...
  <a href="/chains/comparison" className="chain-tag">📊 Comparison</a>
  <a href="/chains/testnets" className="chain-tag">🧪 Testnets</a>
</div>
