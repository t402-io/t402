...
export const alt = "Gasless Payments with ERC-4337 Account Abstraction";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const title = "Gasless Payments with ERC-4337 Account Abstraction";
const category = "Technical";
const color = "#3B82F6";
const slug = "gasless-payments";
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: "8px", flexDirection: "row" }}>
              {["ERC-4337", "Gasless", "Paymaster", "EVM"].map((tag) => (
                <div
                  key={tag}
                  style={{
                    display: "flex",
