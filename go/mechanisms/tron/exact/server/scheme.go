...
// ExactTronScheme implements the SchemeNetworkServer interface for TRON exact payments (V2)
...
func (s *ExactTronScheme) RegisterMoneyParser(parser t402.MoneyParser) *ExactTronScheme {
...
func (s *ExactTronScheme) ParsePrice(price t402.Price, network t402.Network) (t402.AssetAmount, error) {
...
func (s *ExactTronScheme) parseMoneyToDecimal(price t402.Price) (float64, error) {
...
func (s *ExactTronScheme) defaultMoneyConversion(amount float64, config *tron.NetworkConfig) (t402.AssetAmount, error) {
