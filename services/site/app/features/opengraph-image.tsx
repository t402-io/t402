...
export const alt = "Features - T402";
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "24px", color: "#71717A", marginBottom: "40px" }}>
            Everything you need for stablecoin payments
          </p>
          <div style={{ display: "flex", gap: "12px", alignItems: "center", flexDirection: "row" }}>
            {["Multi-Chain", "Gasless", "AI Agents", "Real-time"].map((feature) => (
              <div
                key={feature}
                style={{
                  display: "flex",
                  padding: "8px 16px",
                  borderRadius: "16px",
                  backgroundColor: "rgba(80,175,149,0.1)",
                  border: "1px solid rgba(80,175,149,0.3)",
                }}
              >
                <span style={{ fontSize: "14px", color: "#50AF95", fontWeight: 500 }}>{feature}</span>
              </div>
            ))}
          </div>
        </div>
