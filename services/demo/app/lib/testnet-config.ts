...
export const CHAIN_CONFIGS: Record<ChainFamily, ChainConfig> = {
  ...
  ton: {
    ...
    payTo: "kQDjv9CUEJ__D_3-3J4trQtqVklMBiNoGVSf3Fu6AaDGkP6U",
  ...
  stacks: {
    ...
    asset: "ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.token-susdc",
    ...
    tokenFaucetLabel: "No sUSDC faucet — use Demo mode for Stacks",
  },
  near: {
    family: "near",
    ...
    tokenFaucetLabel: "USDT (usdt.fakes.testnet — select from dropdown)",
  },
  aptos: {
    family: "aptos",
    network: "aptos:2",
