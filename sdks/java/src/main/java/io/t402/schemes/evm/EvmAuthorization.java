...
/**
 * Authorization data for EVM EIP-3009 TransferWithAuthorization payments.
 *
 * <p>Contains all parameters needed to authorize a token transfer
 * on EVM-compatible blockchains using EIP-3009.</p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
...
public class EvmAuthorization {
    ...
    private EvmAuthorization(Builder builder) {
     ...
     *
     * <p>The map uses string representations for numeric values,
     * as expected by the EvmSigner.</p>
     *
    ...
    /**
     * Creates an EvmAuthorization from a map.
     *
     * @param map Map containing authorization data
     * @return New EvmAuthorization instance
     * @throws IllegalArgumentException if required fields are missing
     */
    public static EvmAuthorization fromMap(Map<String, Object> map) {
        return builder()
    ...
    public static class Builder {
        ...
        public EvmAuthorization build() {
            ...
            return new EvmAuthorization(this);
        }
    }
}
