...
<Cards>
  <Cards.Card title="AI Agent Payments" href="/use-cases/ai-payments" />
  <Cards.Card title="API Monetization" href="/use-cases/api-monetization" />
  <Cards.Card title="Premium Content" href="/use-cases/content-access" />
  <Cards.Card title="Micro-Payments" href="/use-cases/micro-payments" />
</Cards>

| Use Case | Description | Price Range |
|----------|-------------|-------------|
| [**AI Agent Payments**](/use-cases/ai-payments) | Enable AI agents to pay for APIs autonomously | $0.001 - $0.10 per call |
...
| [**Micro-Payments**](/use-cases/micro-payments) | Enable sub-cent payments for any resource | $0.0001 - $0.01 per tx |
