...
describe('TRON Multi-Network Integration Tests', () => {
  ...
  describe('Address Comparison', () => {
    it('should compare equal addresses', () => {
      expect(
        addressesEqual('TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t', 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t'),
      ).toBe(true)
    })

    it('should reject different addresses', () => {
      expect(
        addressesEqual('TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t', 'TXYZopYRdj2D9XRtbG411XZZ3kM5VkAeBf'),
      ).toBe(false)
    })
