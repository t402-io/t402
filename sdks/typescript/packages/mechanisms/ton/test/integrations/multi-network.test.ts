...
describe('TON Multi-Network Integration Tests', () => {
  ...
  describe('Network Normalization', () => {
    ...
    it('should throw for unsupported networks', () => {
      expect(() => normalizeNetwork('solana' as Network)).toThrow('Unsupported TON network: solana')
  ...
  describe('Jetton Helper Functions', () => {
    ...
    it('should find Jetton by address', () => {
      const usdtMainnet = getJettonByAddress(TON_MAINNET_CAIP2, USDT_ADDRESSES[TON_MAINNET_CAIP2])
  ...
  describe('Address Validation', () => {
    it('should validate correct TON addresses', () => {
      ...
      // Raw format address
      expect(
        validateTonAddress('0:b113a994b5024a1671df69139328eb759596c38a25f590a8b146fecdc3621dfe'),
      ).toBe(true)
    })
  ...
  describe('Jetton Transfer Operations', () => {
    ...
    it('should build and parse Jetton transfer body', () => {
      ...
      const responseDestination = Address.parse(
        '0:b113a994b5024a1671df69139328eb759596c38a25f590a8b146fecdc3621dfe',
      )
  ...
  describe('Server Price Parsing - Multi-Network', () => {
    const networks: Array<{ name: string; network: Network; usdtAddress: string }> = [
      {
        name: 'Mainnet',
        network: TON_MAINNET_CAIP2 as Network,
        usdtAddress: USDT_ADDRESSES[TON_MAINNET_CAIP2],
      },
      {
        name: 'Testnet',
        network: TON_TESTNET_CAIP2 as Network,
        usdtAddress: USDT_ADDRESSES[TON_TESTNET_CAIP2],
      },
    ]
  ...
  describe('Server AssetAmount Passthrough', () => {
    ...
    it('should throw if AssetAmount missing asset', async () => {
      ...
      await expect(server.parsePrice(invalidAssetAmount as any, TON_MAINNET_CAIP2)).rejects.toThrow(
