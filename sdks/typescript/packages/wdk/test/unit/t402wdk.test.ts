...
describe('T402WDK', () => {
  ...
  describe('Static methods', () => {
    ...
    it('should throw when registering null WDK', () => {
      expect(() => T402WDK.registerWDK(null as unknown as WDKConstructor)).toThrow(
        WDKInitializationError,
      )
      expect(() => T402WDK.registerWDK(null as unknown as WDKConstructor)).toThrow(
        'WDK constructor is required',
      )
    })

    it('should throw when registering non-function WDK', () => {
      expect(() => T402WDK.registerWDK({} as unknown as WDKConstructor)).toThrow(
        WDKInitializationError,
      )
      expect(() => T402WDK.registerWDK({} as unknown as WDKConstructor)).toThrow(
        'WDK must be a constructor function',
      )
    })
