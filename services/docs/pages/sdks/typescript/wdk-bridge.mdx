...
Use the `useBridgePayment` hook (React) or composable (Vue) for UI integration:

```tsx
import { useBridgePayment } from '@t402/react'; // or '@t402/vue'

const { autoBridge, isLoading, txHash, messageGuid, error } = useBridgePayment({
...
See [@t402/react](/reference/react#usebridgepayment) and [@t402/vue](/reference/vue#usebridgepayment) for full API reference.
...
| Unichain | 130 | 30320 | `0x9151434b16b9763660705744891fA906F660EcC5` |
...
- [@t402/evm](/reference/evm) - Core bridge implementation
- [@t402/wdk](/reference/wdk) - WDK account integration
