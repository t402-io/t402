...
%--------------------------------------------------
% Encoding and Fonts (XeLaTeX compatible)
%--------------------------------------------------
\usepackage{iftex}
\ifxetex
    % XeLaTeX: use fontspec with default fonts
    \usepackage{fontspec}
    \defaultfontfeatures{Ligatures=TeX}
    % Use lmodern package for Latin Modern fonts with XeLaTeX
    \usepackage{lmodern}
\else\ifluatex
    % LuaLaTeX: use fontspec with default fonts
    \usepackage{fontspec}
    \defaultfontfeatures{Ligatures=TeX}
    \usepackage{lmodern}
\else
...
% Global listing settings to prevent overfull boxes
\lstset{
    breaklines=true,
    breakatwhitespace=true,
    breakautoindent=true,
    postbreak=\mbox{\textcolor{t402gray}{$\hookrightarrow$}\space},
    columns=flexible,
    keepspaces=true,
    xleftmargin=2em,
    xrightmargin=1em,
...
% HTTP style (for HTTP request/response examples)
\lstdefinelanguage{http}{
    basicstyle=\ttfamily\small,
    keywordstyle=\color{t402purple}\bfseries,
    stringstyle=\color{t402green},
    keywords={GET, POST, PUT, DELETE, PATCH, HEAD, OPTIONS, HTTP/1.1, HTTP/2},
    morestring=[b]",
    numbers=left,
    numberstyle=\tiny\color{t402gray},
    stepnumber=1,
