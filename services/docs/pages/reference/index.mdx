...
| [@t402/near](/reference/near) | NEAR blockchain with NEP-141 fungible tokens |
| [@t402/aptos](/reference/aptos) | Aptos blockchain with Fungible Asset transfers |
| [@t402/tezos](/reference/tezos) | Tezos blockchain with FA2 (TZIP-12) tokens |
| [@t402/polkadot](/reference/polkadot) | Polkadot Asset Hub with system assets |
| [@t402/stacks](/reference/stacks) | Stacks (Bitcoin L2) with SIP-010 tokens |
| [@t402/extensions](/reference/extensions) | Protocol extensions (Bazaar discovery, Sign-In-With-X) |
| [@t402/cli](/reference/cli) | Command-line tools for payments and development |
