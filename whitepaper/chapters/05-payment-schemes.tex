...
Beyond the \code{exact} scheme detailed in this chapter, T402 is designed to support additional payment patterns:

\begin{itemize}
    \item \textbf{Up-To Scheme}: Metered payments using EIP-2612~\cite{eip2612} permits for usage-based billing
    \item \textbf{Permit2 Integration}: Uniswap's universal approval system~\cite{permit2} for improved gas efficiency
    \item \textbf{Subscription Scheme}: Recurring payments with automatic renewal
\end{itemize}
