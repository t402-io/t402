          ...
          {FLOW_STEPS.map((step, i) => (
            <div key={step.state} className="flex items-center">
              ...
              {i < FLOW_STEPS.length - 1 && (
                <div className={`w-10 lg:w-14 h-px mx-1 transition-colors duration-300 ${
              ...
              <div
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${
                  i < currentStep
                    ...
                    : i === currentStep && flow.state !== "idle"
                      ? "w-6 bg-[var(--color-brand)] animate-pulse"
          ...
          <div className="text-center">
            <span className="text-xs font-medium text-white">
              {flow.state !== "idle" && flow.state !== "error"
                ? `Step ${currentStep + 1}: ${FLOW_STEPS[currentStep]?.label}`
                : ""}
            </span>
