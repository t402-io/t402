  ...
  app.get("/examples", (_req, res) => {
    ...
    res.json({
      ...
      curl: {
        ...
        verify_base_sepolia: 'curl -s -X POST https://sandbox.t402.io/verify -H "Content-Type: application/json" -d \'{"paymentPayload":{"payload":{"payer":"0x0000000000000000000000000000000000CAFE01"}},"paymentRequirements":{"network":"eip155:84532"}}\'',
        verify_solana_devnet: 'curl -s -X POST https://sandbox.t402.io/verify -H "Content-Type: application/json" -d \'{"paymentPayload":{"payload":{"payer":"0x0000000000000000000000000000000000CAFE01"}},"paymentRequirements":{"network":"solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1"}}\'',
        verify_ton_testnet: 'curl -s -X POST https://sandbox.t402.io/verify -H "Content-Type: application/json" -d \'{"paymentPayload":{"payload":{"payer":"0x0000000000000000000000000000000000CAFE01"}},"paymentRequirements":{"network":"ton:testnet"}}\'',
        settle: 'curl -s -X POST https://sandbox.t402.io/settle -H "Content-Type: application/json" -d \'{"paymentPayload":{"payload":{"payer":"0x0000000000000000000000000000000000CAFE11"}},"paymentRequirements":{"network":"eip155:84532"}}\'',
        webhook: 'curl -s -X POST https://sandbox.t402.io/webhook/test -H "Content-Type: application/json" -d \'{"url":"https://httpbin.org/post"}\'',
      },
