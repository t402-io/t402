...
const faqs: FAQItem[] = [
  // General
  {
    ...
    answer:
      "T402 is an open-source payment protocol that enables HTTP-native stablecoin (USDT/USDC) payments across 47 networks. It uses the HTTP 402 'Payment Required' status code to embed payments directly into web requests, allowing services to monetize APIs, content, and AI agent interactions without traditional payment processors.",
    category: "general",
  },
  {
    id: "why-402",
  ...
  },
  {
    ...
    answer:
      "T402 supports 47 networks across 10 families: EVM chains (Ethereum, Base, Arbitrum, Optimism, Polygon, etc.), Solana, TON (Telegram), TRON, NEAR, Aptos, Tezos, Polkadot Asset Hub, Stacks (Bitcoin L2), and Cosmos/Noble. Each chain uses its native token standard for USDT/USDC.",
    category: "general",
  },
  {
    id: "open-source",
