...
function IconCircle({ children }: { children: React.ReactNode }) {
  return (
    <motion.div
      className="w-[68px] h-[68px] flex items-center justify-center rounded-full border-2 border-[var(--text-on-light)] bg-white cursor-pointer"
  ...
  return (
    ...
    >
      <span
        ...
        style={{
          backgroundImage: "repeating-linear-gradient(90deg, currentColor 0, currentColor 2px, transparent 2px, transparent 8px)",
        }}
      />
      <span className="absolute -left-[5px] top-1/2 h-2 w-2 -translate-y-1/2 rounded-full bg-current" />
      <span className="absolute -right-[5px] top-1/2 h-2 w-2 -translate-y-1/2 rounded-full bg-current" />
    </motion.div>
  );
}
  ...
  return (
    <section className="section-light py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        {/* Icon row */}
        <motion.div
          className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[var(--text-on-light)]"
        ...
        {/* Content */}
        <div className="mt-10 md:mt-12 flex flex-col md:flex-row items-center md:items-start justify-between gap-10 md:gap-12">
          <div className="flex-1 flex flex-col gap-6 md:gap-8">
            ...
            >
              <motion.h3
                variants={fadeInUp}
                className="text-2xl sm:text-3xl md:text-4xl font-display font-medium tracking-tight mb-3 text-center md:text-left text-[var(--text-on-light)]"
              >
