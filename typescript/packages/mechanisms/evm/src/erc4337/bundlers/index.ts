 ...
 */
export type BundlerProviderConfig<T extends BundlerProvider> = T extends "pimlico"
  ? PimlicoConfig
  : T extends "alchemy"
    ? AlchemyConfig
    : BundlerConfig;
 ...
 */
export type BundlerProviderClient<T extends BundlerProvider> = T extends "pimlico"
  ? PimlicoBundlerClient
  : T extends "alchemy"
    ? AlchemyBundlerClient
    : BundlerClient;
