...
import (
    ...
    "github.com/t402-io/t402/sdks/go/mechanisms/solana/v1"
)
...
**Before (V1)**:
```go
import "github.com/t402-io/t402/sdks/go/mechanisms/solana/v1"
...
**After (V2)**:
```go
import "github.com/t402-io/t402/sdks/go/mechanisms/solana"
