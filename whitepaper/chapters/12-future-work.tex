...
The ``up-to'' scheme enables metered, usage-based billing where clients authorize a maximum amount upfront, and providers settle only the actual usage. The up-to scheme is currently implemented for Solana (SVM), TON, TRON, and NEAR chains. EVM support via Permit2 is planned. This pattern is essential for:
