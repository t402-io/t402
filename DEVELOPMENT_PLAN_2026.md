...
- 50 networks, 81 kinds live on facilitator (all chains including Aptos, Tezos, Polkadot, Stacks, Cosmos, BTC)
...
### Q3-Q4 Priorities (Updated 2026-03-24)

**Strategic Differentiation (NEW — highest priority):**
- x402 (Coinbase) wire format compatibility — DONE (95% identical, shim shipped)
- `@t402/quick` package for 3-line integration — DONE
- Hosted facilitator free tier (1K tx/month)
- "Zero to Paid API in 10 Minutes" tutorial — DONE
- ERC-8004 EIP draft submission
- AI agent payment demo (MCP)
- OpenAPI x-t402 extension
- Payment DNS (/.well-known/t402.json)
- Scan2Pay merchant onboarding wizard for underbanked markets

**Existing priorities (deprioritized):**
- Smart contract external audit (P0 blocker)
- Rust SDK development (deferred — focus on adoption first)
...
### Competitive Landscape (Added 2026-03-24)

The HTTP-native payment protocol space has dramatically shifted:

| Protocol | Backer | Focus | Chains | Stablecoin | Status |
|----------|--------|-------|--------|------------|--------|
| **T402** | Open source | Global/underbanked markets | 33 networks, 13 families | USDT/USDT0 | Production |
| **x402** | Coinbase + Cloudflare | Developer DX, US/EU | Base, Polygon, Solana | USDC | Production |
| **MPP** | Stripe + Paradigm | AI agent payments | Tempo blockchain | Multi-rail | Launched Mar 2026 |
| **AP2** | Google + 60 orgs | Agent-led payments | Multi-platform | Multi-rail | Announced Mar 2026 |

**T402 differentiation strategy:** USDT (4x market cap vs USDC), multi-chain breadth (33 vs 3), independence from US big-tech, x402 wire compatibility (superset position).

**Wire format audit:** T402 and x402 are 95% wire-compatible. Only difference: `t402Version` vs `x402Version` field name. Compatibility shim shipped in `@t402/core`.
...
|-----------|----------|-------|----------|
| TypeScript SDK | 37 packages (v2.7.0) | 3,700+ | 70-95% |
| Go SDK | 92 packages (v1.12.0) | All passing | 45-80%+ |
| Python SDK | v1.12.0 | 2,092 | 85-100% |
| Java SDK | v1.12.0 | 1,369 | Production |
...
All 37 packages aligned to v2.7.0.
...
| 7-8 | Version Alignment | All 37 packages to v2.7.0 | ✅ |
...
| 9-10 | Facilitator | 50 networks, 81 kinds deployed, 77.4% coverage | ✅ |
...
| Networks Live | 50 (81 kinds) | 52 | 55+ |
...
| 2.3 | 2026-02-22 | T402 Team | Updated to v2.7.0/v1.11.1, corrected stats (50 networks/81 kinds), added ERC-8004 + BTC |
| 2.4 | 2026-02-23 | T402 Team | Updated Go/Python/Java SDK versions to v1.12.0 |
| 3.0 | 2026-03-24 | T402 Team | Added competitive landscape (x402/MPP/AP2), strategic differentiation priorities, @t402/quick, x402 compat shim |
