...
Chains & evm, svm, ton, tron, near, aptos, tezos, polkadot, stacks, cosmos, btc & Chain-specific handlers \\
UI & paywall, react, vue, react-native & Frontend components \\
CLI & cli & Command-line interface \\
WDK & wdk, wdk-gasless, wdk-bridge, wdk-multisig, wdk-protocol, wdk-defi, wdk-ton, wdk-ton-gasless, wdk-tron-gasfree & Tether WDK integration \\
\bottomrule
\end{tabular}
\end{table}
