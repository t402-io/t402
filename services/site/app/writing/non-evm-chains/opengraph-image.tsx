...
export const alt = "Beyond EVM: Accepting Payments on TON, Solana, TRON, and More";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const title = "Beyond EVM: Accepting Payments on TON, Solana, TRON, and More";
const category = "Technical";
const color = "#0EA5E9";
const slug = "non-evm-chains";
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: "6px", flexDirection: "row", flexWrap: "wrap", justifyContent: "flex-end" }}>
              {["TON", "Solana", "TRON", "NEAR", "Aptos", "Tezos", "Polkadot", "Stacks"].map((chain) => (
                <div
                  key={chain}
                  style={{
                    display: "flex",
                ...
                >
                  <span style={{ fontSize: "12px", color: "#A1A1AA", fontWeight: 500 }}>{chain}</span>
                </div>
              ))}
            </div>
          </div>
