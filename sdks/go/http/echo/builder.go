...
//	}))
func T402Payment(config Config) echo.MiddlewareFunc {
	// Set defaults
	if config.Timeout == 0 {
...
// Example:
//
//	e.Use(echomw.SimpleT402Payment(
//	    "0x123...",
//	    "$0.001",
//	    "eip155:8453",
//	    "https://facilitator.example.com",
//	))
func SimpleT402Payment(payTo string, price string, network t402.Network, facilitatorURL string) echo.MiddlewareFunc {
