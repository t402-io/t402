...
\node[service] (evm) at (-3,-0.8) {EVM\\Handler};
\node[service] (sol) at (-1,-0.8) {Solana\\Handler};
\node[service] (ton) at (1,-0.8) {TON\\Handler};
\node[service] (more) at (3,-0.8) {+7 more};
...
\node[panel] at (0,-2.5) {Active\\Networks\\[0.3cm]\Large 44};
