...
<body>
  ...
  <div class="tx-detail">
    ...
    ${tx.referer ? `<div class="detail-row"><span class="detail-label">Source</span><span class="detail-value"><a href="${escapeHtml(tx.referer)}" target="_blank" rel="noopener noreferrer">${escapeHtml(tx.referer)}</a></span></div>` : ""}
