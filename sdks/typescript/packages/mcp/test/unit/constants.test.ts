...
describe('Helper Functions', () => {
  describe('getExplorerTxUrl', () => {
    it('should generate correct explorer URLs', () => {
      ...
      expect(getExplorerTxUrl('ethereum', txHash)).toBe(`https://etherscan.io/tx/${txHash}`)
      expect(getExplorerTxUrl('base', txHash)).toBe(`https://basescan.org/tx/${txHash}`)
      expect(getExplorerTxUrl('arbitrum', txHash)).toBe(`https://arbiscan.io/tx/${txHash}`)
    })
  })
  ...
  describe('getLayerZeroScanUrl', () => {
    it('should generate correct LayerZero Scan URL', () => {
      ...
      expect(getLayerZeroScanUrl(messageGuid)).toBe(`https://layerzeroscan.com/tx/${messageGuid}`)
    })
  })
  ...
  describe('getTokenAddress', () => {
    ...
    it('should return correct addresses for USDT0', () => {
      expect(getTokenAddress('ethereum', 'USDT0')).toBe(USDT0_ADDRESSES.ethereum)
  ...
  describe('formatTokenAmount', () => {
    ...
    it('should handle 18 decimal tokens', () => {
      ...
      expect(formatTokenAmount(1500000000000000000n, 18, 'ETH')).toBe('1.5 ETH')
    })
  })
