...
export const alt = "How T402 Achieves Multi-Chain Payment Settlement";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const title = "How T402 Achieves Multi-Chain Payment Settlement";
const category = "Architecture";
const color = "#6366F1";
const slug = "multichain-architecture";
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: "8px", flexDirection: "row" }}>
              {["CAIP-2", "44 Networks", "10 Families", "Facilitator"].map((tag) => (
                <div
                  key={tag}
                  style={{
                    display: "flex",
