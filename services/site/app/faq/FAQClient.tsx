...
const faqs: FAQItem[] = [
  // General
  {
    ...
    answer:
      "T402 is an open-source payment protocol that enables HTTP-native stablecoin (USDT/USDC) payments across 28 blockchains. It uses the HTTP 402 'Payment Required' status code to embed payments directly into web requests, allowing services to monetize APIs, content, and AI agent interactions without traditional payment processors.",
    category: "general",
  },
  {
    id: "why-402",
  ...
  },
  {
    ...
    answer:
      "T402 supports 28 blockchains across 10 families: 19 EVM chains (Ethereum, Base, Arbitrum, Optimism, Polygon, etc.), Solana, TON (Telegram), TRON, NEAR, Aptos, Tezos, Polkadot Asset Hub, Stacks (Bitcoin L2), and Cosmos/Noble. Each chain uses its native token standard for USDT/USDC.",
    category: "general",
  },
  {
    id: "open-source",
  ...
  },
  {
    ...
    answer:
      "T402 offers official SDKs for TypeScript/JavaScript, Python, Go, and Java. TypeScript has the most complete ecosystem with 21 packages including React/Vue components. All SDKs support the same 28 blockchains with identical payment flows.",
    category: "integration",
  },
  {
    id: "frameworks",
