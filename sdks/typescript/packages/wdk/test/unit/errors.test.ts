...
describe('Error Classes', () => {
  ...
  describe('ChainError', () => {
    it('should include chain in context', () => {
      const error = new ChainError(WDKErrorCode.CHAIN_NOT_CONFIGURED, 'Chain not configured', {
        chain: 'polygon',
      })
  ...
  describe('SignerError', () => {
    it('should include chain and address', () => {
      const error = new SignerError(WDKErrorCode.SIGNER_NOT_INITIALIZED, 'Signer failed', {
        chain: 'arbitrum',
        address: '0x1234',
      })
  ...
  describe('SigningError', () => {
    it('should include operation type', () => {
      const error = new SigningError(WDKErrorCode.SIGN_TYPED_DATA_FAILED, 'Signing failed', {
  ...
  describe('TransactionError', () => {
    it('should include chain and txHash', () => {
      const error = new TransactionError(WDKErrorCode.TRANSACTION_FAILED, 'Transaction failed', {
        chain: 'base',
        txHash: '0xabc123',
      })
  ...
  describe('BridgeError', () => {
    it('should include fromChain and toChain', () => {
      const error = new BridgeError(WDKErrorCode.BRIDGE_FAILED, 'Bridge failed', {
        fromChain: 'ethereum',
        toChain: 'arbitrum',
      })
  ...
  describe('RPCError', () => {
    it('should include endpoint and rpcCode', () => {
      const error = new RPCError(WDKErrorCode.RPC_ERROR, 'RPC error', {
...
describe('Error Utilities', () => {
  ...
  describe('withRetry', () => {
    ...
    it('should not retry on non-retryable errors', async () => {
      const error = new SigningError(WDKErrorCode.INVALID_TYPED_DATA, 'Invalid data', {
        operation: 'signTypedData',
      })
