...
const pageDescription =
  "T402 brings HTTP-native stablecoin payments to the internet. Zero fees, instant settlement, and support for 50 networks across 10 families.";
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-10" style={{ lineHeight: "1.8" }}>
              ...
              >
                <p className="text-base" style={{ color: "#4A5568" }}>
                  <strong style={{ color: "#1A1A2E" }}>TL;DR</strong>: T402 is an open-source payment protocol that embeds USDT payments directly into HTTP. It supports 50 networks across 10 families, offers zero transaction fees, instant settlement, and is designed for both human users and AI agents. Start accepting payments in minutes with our production-ready SDKs.
                </p>
              </div>
              ...
              <section className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    { title: "50 Networks", desc: "EVM, Solana, TON, TRON, NEAR, Aptos, Tezos, Polkadot, Stacks, and Cosmos across 10 blockchain families." },
              ...
              <section className="space-y-4">
                ...
                <p className="text-base" style={{ color: "#4A5568" }}>
                  T402 supports payments across 50 networks, spanning 10 blockchain families:
                </p>
