/**
 * Lazy loader for NEAR paywall template
...
export function getNearTemplate(): string | null {
  ...
  try {
    ...
    const { NEAR_PAYWALL_TEMPLATE } = require("./gen/template");
    cachedTemplate = NEAR_PAYWALL_TEMPLATE;
    return cachedTemplate;
  } catch {
