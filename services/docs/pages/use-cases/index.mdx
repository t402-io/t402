...
<div className="feature-grid">
  <a href="/use-cases/ai-payments" className="feature-card" style={{textDecoration: 'none', color: 'inherit'}}>
    <div className="feature-title">AI Agent Payments</div>
    <p className="feature-desc">Enable AI agents to pay for APIs autonomously. $0.001 - $0.10 per call.</p>
  </a>
  <a href="/use-cases/api-monetization" className="feature-card" style={{textDecoration: 'none', color: 'inherit'}}>
    <div className="feature-title">API Monetization</div>
    <p className="feature-desc">Charge per-request fees for your API endpoints. $0.01 - $1.00 per request.</p>
  </a>
  <a href="/use-cases/content-access" className="feature-card" style={{textDecoration: 'none', color: 'inherit'}}>
    <div className="feature-title">Premium Content</div>
    <p className="feature-desc">Gate content behind micro-payments. $0.10 - $10.00 per item.</p>
  </a>
  <a href="/use-cases/micro-payments" className="feature-card" style={{textDecoration: 'none', color: 'inherit'}}>
    <div className="feature-title">Micro-Payments</div>
    <p className="feature-desc">Sub-cent payments for any resource. $0.0001 - $0.01 per tx.</p>
  </a>
</div>
...
- **API Service with < $0.01 per call** → [Micro-Payments + Gasless](/use-cases/micro-payments)
- **API Service with $0.01 - $1 per call** → [API Monetization](/use-cases/api-monetization)
- **API Service with > $1 per call** → Premium API
- **Content** → [Content Access](/use-cases/content-access)
- **AI Integration** → [AI Payments + MCP](/use-cases/ai-payments)

## Resources

- [Protocol Specification](/reference) - Technical details of the t402 protocol
- [Supported Chains](/chains) - Full list of supported blockchains
- [Advanced Configuration](/advanced) - MCP, extensions, and more
- [Quick Start](/getting-started/quickstart) - Get started in 5 minutes
