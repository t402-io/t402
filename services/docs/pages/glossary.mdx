...
### Network
A blockchain network identified by CAIP-2 format. T402 supports EVM chains (`eip155:*`), TON, TRON, Solana, NEAR, Aptos, Tezos, Polkadot, and Stacks.
...
- `X-Payment`: Payment authorization from client
- `X-Payment-Response`: Settlement confirmation from server
