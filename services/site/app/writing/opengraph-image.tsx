      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "24px", color: "#71717A", marginBottom: "40px" }}>
            Tutorials, guides, and technical deep-dives
          </p>
          <div style={{ display: "flex", gap: "12px", alignItems: "center", flexDirection: "row" }}>
            {["Tutorials", "Architecture", "Technical", "Announcements"].map((cat) => (
              <div
                key={cat}
                style={{
                  display: "flex",
              ...
              >
                <span style={{ fontSize: "14px", color: "#50AF95", fontWeight: 500 }}>{cat}</span>
              </div>
            ))}
          </div>
        </div>
