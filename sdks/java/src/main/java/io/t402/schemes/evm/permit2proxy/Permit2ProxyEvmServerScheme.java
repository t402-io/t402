...
/**
 * Server scheme for Permit2 Proxy EVM payment processing.
 *
 * <p>Handles parsing prices and generating payment requirements
 * for the permit2-proxy payment scheme on EVM-compatible chains.</p>
 *
 * <h2>Usage Example</h2>
 * <pre>{@code
 * Permit2ProxyEvmServerScheme scheme = new Permit2ProxyEvmServerScheme("eip155:8453");
 *
 ...
 * }</pre>
 */
public class Permit2ProxyEvmServerScheme {
    ...
    public Permit2ProxyEvmServerScheme() {
        this(EvmConstants.ETHEREUM_MAINNET);
    }

    /**
     * Creates a new Permit2ProxyEvmServerScheme with specified default network.
     *
     ...
     */
    public Permit2ProxyEvmServerScheme(String defaultNetwork) {
    ...
    public Map<String, Object> getPaymentRequirements(
        ...
        // Add Permit2 Proxy-specific extra
    ...
    /**
     * Validates that payment requirements are valid for Permit2 Proxy.
     *
