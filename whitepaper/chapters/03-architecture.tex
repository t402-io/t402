...
X-PAYMENT-REQUIRED: eyJ0NDAyVmVyc2lvbiI6Mi4uLn0=
...
The Base64-encoded \code{X-PAYMENT-REQUIRED} header contains the full \code{PaymentRequired} schema (see \cref{sec:payment-required}).
...
Host: api.example.com
Accept: application/json
X-PAYMENT: eyJ0NDAyVmVyc2lvbiI6Mi4uLn0=
\end{lstlisting}
...
The \code{X-PAYMENT-RESPONSE} header contains the blockchain transaction hash, providing cryptographic proof of payment.
...
% Bottom row chains (4)
\node[chainbox, draw=orange!70, fill=orange!15] (aptos) at (-4.1,-1.5) {Aptos};
\node[chainbox, draw=teal!70, fill=teal!15] (tezos) at (-1.37,-1.5) {Tezos};
\node[chainbox, draw=pink!70, fill=pink!15] (polkadot) at (1.37,-1.5) {Polkadot};
\node[chainbox, draw=brown!70, fill=brown!15] (stacks) at (4.1,-1.5) {Stacks};
...
% Features (bottom row)
\node[font=\tiny] at (-4.1,-2.1) {FA};
\node[font=\tiny] at (-1.37,-2.1) {FA2};
\node[font=\tiny] at (1.37,-2.1) {Asset Hub};
\node[font=\tiny] at (4.1,-2.1) {SIP-010};
...
\draw[->, thick, violet!60] (tron.south) -- (polkadot.north);
\draw[->, thick, violet!60] (near.south) -- (stacks.north);

\end{tikzpicture}
\caption{T402 multi-chain architecture: 9 blockchain families, 30+ networks}
