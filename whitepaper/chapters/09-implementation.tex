...
\midrule
TypeScript & 2.4.0 & npm @t402/* & Express, Fastify, Next.js & Apache 2.0 \\
Python & 1.10.0 & PyPI & FastAPI, Flask, Django & Apache 2.0 \\
Go & 1.9.0 & Go Modules & Gin, Echo, Chi & Apache 2.0 \\
Java & 1.9.0 & Maven Central & Spring Boot, WebFlux & Apache 2.0 \\
\bottomrule
\end{tabular}
\end{table}
...
import (
    ...
    "github.com/t402-io/t402/sdks/go/middleware"
...
import (
    ...
    "github.com/t402-io/t402/sdks/go/client"
    "github.com/t402-io/t402/sdks/go/schemes/evm"
)
...
describe("Payment Middleware", () => {
  ...
  it("should accept valid payment", async () => {
    ...
    const response = await request(app)
      .get("/api/premium")
      .set("X-PAYMENT", encodePayment(payment))
      .expect(200);
