...
% Stripe: 2.9% + $0.30
\addplot[color=blue, thick, domain=1:100, samples=100]
    {(0.30 + 0.029*x) / x * 100};
\addlegendentry{Stripe (2.9\% + \$0.30)}

% PayPal: 3.49% + $0.49
\addplot[color=red, thick, domain=1:100, samples=100]
    {(0.49 + 0.0349*x) / x * 100};
\addlegendentry{PayPal (3.49\% + \$0.49)}

% T402: 1% (flat)
\addplot[color=green!60!black, thick, domain=0:100]
    {1};
\addlegendentry{T402 (1\% flat)}

% T402: 0% (self-host)
\addplot[color=violet, thick, dashed, domain=0:100]
    {0.1};
\addlegendentry{T402 (self-host, gas only)}

\end{axis}
\end{tikzpicture}
\caption{Fee percentage by transaction size (note: traditional providers exceed 40\% for amounts under \$1)}
